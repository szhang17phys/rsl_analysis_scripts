...
void rsl_compareTMP(const std::string& path, int biasLabel){
    ...
    const int num = 100; //num of slices---
...
*/
    ...
    scatterGraph->GetXaxis()->SetRangeUser(0, 20);
...
//Drawing 2-------------------------------------------------------------------
    ...
    graphDiff50->GetXaxis()->SetRangeUser(0, 20);
...
//Drawing 3-------------------------------------------------------------------
    ...
    graphBias50->GetXaxis()->SetRangeUser(0, 20);
    ...
    graphBias70->GetXaxis()->SetRangeUser(0, 20);
...
//    graphBias130->Draw("P SAME");
    ...
    graphBias150->GetXaxis()->SetRangeUser(0, 20);
...
void rsl_compare_m2(){
    ...
    //For membrane1---
    rsl_compareTMP("/Users/shuaixiangzhang/Work/current/FNAL_Work2024/rsl_analyses/v4_analysis/results/fit_Develop_newDistance2/membrane2", 1); //1: initial bias; 2: new bias
