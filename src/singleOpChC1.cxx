...
void singleOpChC1(string file_suffix, string output_path, Int_t opch, string opch_string) {
    ...
    //Old: 100, 0, 200000; Current: 100, 0, 5000000
    TH2F* CRT_XA_response = new TH2F("CRT_Opch", "CRT_Opch", 100, 0, 1000, 800, 0, 200000);

    TH2F* CRT_XA_distance = new TH2F("dis_angle", "dis_angle", 1000, 0, 1000, 300, 0, 300);
...
int main(int argc, char *argv[]) {
    ...
    singleOpChC1(param1, param2, param3, param4);
