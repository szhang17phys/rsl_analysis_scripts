...
void singleOpChM2(string file_suffix, string output_path, Int_t opch, string opch_string) {
...
//    TH2F* CRT_XA_response = new TH2F("CRT_Opch", "CRT_Opch", 60, 0, 600, 800, 0, 2000);
    ...
    TH2F* CRT_XA_distance = new TH2F("dis_angle", "dis_angle", 600, 0, 20, 600, 0, 600);//solid angle---
...
int main(int argc, char *argv[]) {
    ...
    singleOpChM2(param1, param2, param3, param4);
