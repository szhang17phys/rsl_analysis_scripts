...
void rsl_compareTMP(const std::string& path, int biasLabel){
    ...
    std::ifstream file(inputFile99);
    const int num = std::count(std::istreambuf_iterator<char>(file), std::istreambuf_iterator<char>(), '\n');
    cout<<"Num of Line: "<<num<<endl;
...
//            std::cout<<"bias 50: "<< bias50[i] << " , sig: "<< sigBias50[i] <<std::endl;
        ...
        titleY = "2*(RSLxx - RSL100) / (RSLxx + RSL100)";
    }
...
//==========Main Function===============================================
void rsl_compare_m1_down(){

    //For membrane1---
    rsl_compareTMP("/Users/shuaixiangzhang/Work/current/FNAL_Work2024/rsl_analyses/v4_analysis/results/fit_Develop_newDistance/m1_down", 1); //1: initial bias; 2: new bias
