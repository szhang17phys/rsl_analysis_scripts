...
int energyD_combine(){
    ...
    TFile *file0 = new TFile("/Users/shuaixiangzhang/Work/current/FNAL_Work2024/rsl_analyses/v4_analysis/results/tmp/opCh00_rsl99_1000num_e67_hist.root", "READ");
   ...
   //Create NEW root file--------------------------------------------------------
    ...
    TGraph *graphC = new TGraph(graph0->GetN() + graph1->GetN());
