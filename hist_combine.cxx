...
int hist_combine(){
    ...
    TFile *file0 = new TFile("../results/tmp/Combine_rsl150_1000num_e67_hist.root", "READ");
    if (!file0 || file0->IsZombie()) {
        std::cerr << "Error: Unable to open file1.root" << std::endl;
        return 1;
    }
    //Open the second root file---
    TFile *file1 = new TFile("../results/tmp/Combine_rsl150_1000num2_e67_hist.root", "READ");
...
//    TFile *file2 = new TFile("./results/rsl99_500num/Combine_Response.root", "READ");
    ...
    string output_name = "rsl150_2000num_e67_crtCut.root";
    //===================================================
