...
void rsl_compare(){
    ...
    std::string inputFile99 = "../results/fit_Develop/cathode/rsl99_fit.txt";
    double dis99[num];
    double mpv99[num];
    double sig99[num];
    readFile(inputFile99, dis99, mpv99, sig99, num);

    std::string inputFile70 = "../results/fit_Develop/cathode/rsl70_fit.txt";
    double dis70[num];
    double mpv70[num];
    double sig70[num];
    readFile(inputFile70, dis70, mpv70, sig70, num);

    std::string inputFile50 = "../results/fit_Develop/cathode/rsl50_fit.txt";
    double dis50[num];
    double mpv50[num];
    double sig50[num];
    readFile(inputFile50, dis50, mpv50, sig50, num);

    std::string inputFile150 = "../results/fit_Develop/cathode/rsl150_fit.txt";
    double dis150[num];
    double mpv150[num];
    double sig150[num];
...
//    lineGraph->Draw("L");
    ...
    //Create root file---------------
    TFile* outputFile = new TFile("../results/fit_Develop/cathode/fitResults_compare.root", "RECREATE");
