...
//    string file_suffix = rsl + "_1000num_e67_crtCut.root";
    string output_path = "/Users/shuaixiangzhang/Work/current/FNAL_Work2024/rsl_analyses/v4_analysis/results/fit_Develop_slice10cm/cathode/";
    string output_name = "fitCLG1";

    //store fitting results at txt file---
    std::ofstream outputTxt("/Users/shuaixiangzhang/Work/current/FNAL_Work2024/rsl_analyses/v4_analysis/results/fit_Develop_slice10cm/cathode/"+rsl+"_fitCLG1.txt");
...
//    TH2F* inputTH2F = (TH2F*)inputFile->Get("cathode8XA");
    ...
    for(int i=0; i<num; ++i){
        ...
        vars.widthIni = 5.0;//Landau width---
        vars.widthMin = 0.001;
        vars.widthMax = 100.0;
        ...
        if(rsl == "rsl99" && distances[i] == 15){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 60.0;
            varsTMP.mpvIni = 60.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        }  
        else if(rsl == "rsl99" && distances[i] == 25){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 45.0;
            varsTMP.mpvIni = 45.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        }
        else if(rsl == "rsl99" && distances[i] == 65){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.meanMin = 0.0;
            varsTMP.meanMax = 0.0;
            varsTMP.sigmaIni = 3.0;
            varsTMP.sigmaMin = 3.0;
            varsTMP.sigmaMax = 3.0;
            varsTMP.mpvIni = 30.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        }  
        else if(rsl == "rsl99" && distances[i] == 135){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 7.0;
            varsTMP.mpvIni = 7.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        } 
        else if(rsl == "rsl99" && distances[i] == 155){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 5.0;
            varsTMP.mpvIni = 6.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        } 
        else if(rsl == "rsl99" && distances[i] == 185){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.meanMin = 0.0;
            varsTMP.meanMax = 0.0;
            ...
            varsTMP.mpvMin = 8.0;
            varsTMP.mpvMax = 8.6;
            varsTMP.sigmaIni = 1.0;
            varsTMP.widthIni = 0.1;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        }   
        else if(rsl == "rsl99" && distances[i] == 195){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 3.0;
            varsTMP.mpvIni = 4.4;
            varsTMP.sigmaIni = 1.0;
        ...
        else if(rsl == "rsl99" && distances[i] == 215){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 3.0;
            varsTMP.mpvIni = 4.0;
            varsTMP.sigmaIni = 0.7;
            varsTMP.widthIni = 0.1;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        }   
        else if(rsl == "rsl99" && distances[i] == 225){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 3.0;
            varsTMP.mpvIni = 3.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        }  
        else if(rsl == "rsl99" && distances[i] == 235){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 4.0;
            varsTMP.mpvIni = 3.0;
        ...
        else if(rsl == "rsl99" && distances[i] == 245){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 3.0;
            varsTMP.mpvIni = 3.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        ...
        else if(rsl == "rsl50" && distances[i] == 15){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 60.0;
            varsTMP.mpvIni = 60.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        }  
        else if(rsl == "rsl50" && distances[i] == 25){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 45.0;
            varsTMP.mpvIni = 45.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        }
        else if(rsl == "rsl50" && distances[i] == 65){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 15.0;
            varsTMP.mpvIni = 15.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        } 
        else if(rsl == "rsl50" && distances[i] == 205){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 3.5;
            varsTMP.mpvIni = 3.5;
            varsTMP.sigmaIni = 1.0;
        ...
        else if(rsl == "rsl50" && distances[i] == 215){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 3.0;
            varsTMP.mpvIni = 3.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        } 
        else if(rsl == "rsl50" && distances[i] == 225){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 3.0;
            varsTMP.mpvIni = 3.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        } 
      else if(rsl == "rsl50" && distances[i] == 235){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 2.25;
            varsTMP.meanMin = 2.2;
            varsTMP.meanMax = 2.3;
            varsTMP.mpvIni = 3.0;
            varsTMP.mpvMin = 3.0;
        ...
        else if(rsl == "rsl70" && distances[i] == 15){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 60.0;
            varsTMP.mpvIni = 60.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        }  
        else if(rsl == "rsl70" && distances[i] == 25){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 45.0;
            varsTMP.mpvIni = 45.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        }
        else if(rsl == "rsl70" && distances[i] == 65){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 15.0;
            varsTMP.mpvIni = 15.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        }
        else if(rsl == "rsl70" && distances[i] == 135){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 7.0;
            varsTMP.mpvIni = 7.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        } 
        else if(rsl == "rsl70" && distances[i] == 205){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 3.0;
            varsTMP.mpvIni = 4.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        } 
        else if(rsl == "rsl70" && distances[i] == 225){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 3.0;
            varsTMP.mpvIni = 3.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        } 
        else if(rsl == "rsl70" && distances[i] == 245){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 2.0;
            varsTMP.mpvIni = 3.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        ...
        else if(rsl == "rsl130" && distances[i] == 15){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 60.0;
            varsTMP.mpvIni = 60.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        }  
        else if(rsl == "rsl130" && distances[i] == 25){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 45.0;
            varsTMP.mpvIni = 45.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        }
        else if(rsl == "rsl130" && distances[i] == 65){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 15.0;
            varsTMP.mpvIni = 15.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        }
        else if(rsl == "rsl130" && distances[i] == 115){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.mpvIni = 17.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        } 
        else if(rsl == "rsl130" && distances[i] == 185){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 7.0;
            varsTMP.mpvIni = 2.0;
            varsTMP.sigmaIni = 1.0;
        ...
        else if(rsl == "rsl130" && distances[i] == 205){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 5.0;
            varsTMP.mpvIni = 5.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        } 
        else if(rsl == "rsl130" && distances[i] == 235){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 3.0;
            varsTMP.mpvIni = 4.0;
            varsTMP.sigmaIni = 0.5;
        ...
        else if(rsl == "rsl150" && distances[i] == 15){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 60.0;
            varsTMP.mpvIni = 60.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        }  
        else if(rsl == "rsl150" && distances[i] == 25){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 45.0;
            varsTMP.mpvIni = 45.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        }
        else if(rsl == "rsl150" && distances[i] == 65){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 15.0;
            varsTMP.mpvIni = 15.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        }    
        else if(rsl == "rsl150" && distances[i] == 125){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0.0;
            varsTMP.mpvIni = 15.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        }  
        else if(rsl == "rsl150" && distances[i] == 135){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 6.0;
            varsTMP.meanMin = 6.0;
            varsTMP.meanMax = 1.5;
        ...
        else if(rsl == "rsl150" && distances[i] == 215){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 5.0;
            varsTMP.meanMin = 2.0;
            varsTMP.meanMax = 0.4;
        ...
        else if(rsl == "rsl150" && distances[i] == 225){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 4.0;
            varsTMP.mpvIni = 4.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
        } 
        else if(rsl == "rsl150" && distances[i] == 185){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 4.85;
            varsTMP.meanMin = 4.7;
            varsTMP.meanMax = 5.0;
            varsTMP.mpvIni = 4.0;
            varsTMP.mpvMin = 4.0;
        ...
        else if(rsl == "rsl150" && distances[i] == 245){
            FitVars varsTMP = vars;
            varsTMP.meanIni = 0;
            varsTMP.mpvIni = 6.0;
            tmpResults = CLG1(hists[i], outputFile, varsTMP, name); 
