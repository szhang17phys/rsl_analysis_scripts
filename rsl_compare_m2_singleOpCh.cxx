...
void rsl_compareTMP(const std::string& path){
    ...
    std::string inputFile50_opch01 = path + "/output_rsl50_opch01.txt";
    std::string inputFile50_opch03 = path + "/output_rsl50_opch03.txt";
    std::string inputFile50_opch16 = path + "/output_rsl50_opch16.txt";
    std::string inputFile50_opch22 = path + "/output_rsl50_opch22.txt";

    std::string inputFile70_opch01 = path + "/output_rsl70_opch01.txt";
    std::string inputFile70_opch03 = path + "/output_rsl70_opch03.txt";
    std::string inputFile70_opch16 = path + "/output_rsl70_opch16.txt";
    std::string inputFile70_opch22 = path + "/output_rsl70_opch22.txt";

    std::string inputFile130_opch01 = path + "/output_rsl130_opch01.txt";
    std::string inputFile130_opch03 = path + "/output_rsl130_opch03.txt";
    std::string inputFile130_opch16 = path + "/output_rsl130_opch16.txt";
    std::string inputFile130_opch22 = path + "/output_rsl130_opch22.txt";

    std::string inputFile150_opch01 = path + "/output_rsl150_opch01.txt";
    std::string inputFile150_opch03 = path + "/output_rsl150_opch03.txt";
    std::string inputFile150_opch16 = path + "/output_rsl150_opch16.txt";
    std::string inputFile150_opch22 = path + "/output_rsl150_opch22.txt";
...
//    graphDiff50_opch01->Draw("AP");
    ...
    graphDiff50_opch01->GetXaxis()->SetRangeUser(0, 600);
...
//    graphDiff50_opch03->Draw("P SAME");
    ...
    graphDiff50_opch03->GetXaxis()->SetRangeUser(0, 600);
...
//Drawing 3================================================================
    ...
    graphBias50_opch01->GetXaxis()->SetRangeUser(0, 600);
