...
void slice_fitTMP(const std::string& rsl, const std::string& opch){
    //change file name each time-----------------------
    string file_path = "/Users/shuaixiangzhang/Work/current/FNAL_Work2024/rsl_analyses/v4_analysis/results/fit_Develop/combine_3000results/";
    string file_suffix = "singleOpCh_" + rsl + "_3000num_e67_crtCut.root";   
    string output_path = "/Users/shuaixiangzhang/Work/current/FNAL_Work2024/rsl_analyses/v4_analysis/results/fit_Develop/membrane1/";
    ...
    for(int i=0; i<num; ++i){
        ...
        if(00 <= distances[i] && distances[i]<300){//hist has 100 bins; initial 800
            combineBins(hists[i]);
            combineBins(hists[i]);
            combineBins(hists[i]);
        }
...
//Main function!============================================
void slice_fit_m1_singleOpCh(){

//    slice_fitTMP("rsl99", "opch00");
//    slice_fitTMP("rsl99", "opch02");
//    slice_fitTMP("rsl99", "opch17");
//    slice_fitTMP("rsl99", "opch23");

    slice_fitTMP("rsl50", "opch00");
    slice_fitTMP("rsl50", "opch02");
    slice_fitTMP("rsl50", "opch17");
    slice_fitTMP("rsl50", "opch23");

    slice_fitTMP("rsl70", "opch00");
    slice_fitTMP("rsl70", "opch02");
    slice_fitTMP("rsl70", "opch17");
    slice_fitTMP("rsl70", "opch23");

    slice_fitTMP("rsl130", "opch00");
    slice_fitTMP("rsl130", "opch02");
    slice_fitTMP("rsl130", "opch17");
    slice_fitTMP("rsl130", "opch23");

    slice_fitTMP("rsl150", "opch00");
    slice_fitTMP("rsl150", "opch02");
    slice_fitTMP("rsl150", "opch17");
    slice_fitTMP("rsl150", "opch23");
